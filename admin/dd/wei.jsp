...
<TBODY>
     <tr class="head"> 
      ...
      <td  align="center">发票</td>
      <td  align="center">删除</td>
    </tr>
    <%
			List pagelist3=hk.getALLYUDINGTYPE("超时取消");
	...
	<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
      ...
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><%=pagelist2.get(17).toString() %></td>     
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><%=pagelist2.get(22).toString() %></td>
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath %>HkServlet?method=SENDYUDING&id=<%=pagelist2.get(15).toString()%>">发票</a></td>
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath %>HkServlet?method=ADMINdelYUDING&id=<%=pagelist2.get(15).toString()%>">删除</a></td>
    </tr>
